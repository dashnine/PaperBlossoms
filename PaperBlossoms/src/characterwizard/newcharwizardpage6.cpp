...
NewCharWizardPage6::NewCharWizardPage6(DatabaseDependency *deps, QWidget *parent) :
    QWizardPage(parent),
...
void NewCharWizardPage6::initializePage()
{
    ...
    ui->nc6_q18_ancestor1_comboBox->addItems(deps->hertiagesRepository->qsl_getancestors("Core"));
    ui->nc6_q18_ancestor2_comboBox->addItems(deps->hertiagesRepository->qsl_getancestors("Core"));
   ...
   QStringList bonds = deps->bondsRepository->qsl_getbonds();
...
{
    QStringList rangestrings = deps->hertiagesRepository->qsl_getancestorranges(ui->heritagetable_comboBox->currentText());
    int roll = rand()%10+1;
    int index = 0;
...
void NewCharWizardPage6::on_nc6_q18_ancestor1_comboBox_currentIndexChanged(const QString &arg1)
{
   ...
   const QStringList mods = deps->hertiagesRepository->qsl_getancestormods(arg1);
   QString modstr = "";
...
void NewCharWizardPage6::doPopulateEffects(){
    ...
    QStringList effects = deps->hertiagesRepository->qsl_getancestorseffects(ancestor);
    //start by removing effect placeholders -- these will get added in on page 7 automatically.
    ////////
    ///Shadowlands
    if(effects.contains(deps->dal->translate("Fallen Ancestor"))){
        effects.removeAll(deps->dal->translate("Fallen Ancestor"));
        effects.append(tr("No Change"));
    }
    effects.removeAll(deps->dal->translate("Haunting"));
    //Court
    effects.removeAll(deps->dal->translate("Isolation"));
    effects.removeAll(deps->dal->translate("Benten's Curse"));
    if(effects.contains(deps->dal->translate("Fallen Ancestor"))){
        effects.removeAll(deps->dal->translate("Fallen Ancestor"));
        effects.append(tr("No Change"));
    }
    //Celestial realms - CR
    if(effects.contains(deps->dal->translate("Whispers of Failure"))){
        effects.removeAll(deps->dal->translate("Whispers of Failure"));
        effects.append(tr("No Change"));
    }
...
void NewCharWizardPage6::buildq18UI(){ //this is all still in initializePage
    ...
    if(curAncestor == ""){
    ...
    else if(curAncestor == deps->dal->translate("Famous Deed") ||
            curAncestor == deps->dal->translate("Glorious Sacrifice") ||
            curAncestor == deps->dal->translate("Triumph Over the Lion") ||
            curAncestor == deps->dal->translate("Sacrifice") ||
            curAncestor == deps->dal->translate("Blade of 10,000 Battles") ||
            curAncestor == deps->dal->translate("Victory against the Crane")
    ...
    else if (curAncestor == deps->dal->translate("Imperial Heritage") ||
             curAncestor == deps->dal->translate("Triumph During Gempuku") ||
    ...
    else if (curAncestor == deps->dal->translate("Unusual Name Origin")){
        ui->nc6_q18_otherLabel->setVisible(true);
        ui->nc6_q18_otherComboBox->setVisible(true);
        ui->nc6_q18_otherrollButton->setVisible(false);
        ...
        if(ui->nc6_q18_otherComboBox->currentText() == deps->dal->translate("Ring Exchange")){
            ui->nc6_q18_secondaryChoice_comboBox->setVisible(false);
            ui->nc6_q18_secondaryChoice_label->setVisible(false);
            ui->nc6_q18_special1_comboBox->setVisible(true);
            ui->nc6_q18_special2_comboBox->setVisible(true);
    ...
    else if (curAncestor == deps->dal->translate("Mighty Conqueror")) {
        ui->nc6_q18_otherLabel->setVisible(true);
        ui->nc6_q18_otherComboBox->setVisible(true);
        ui->nc6_q18_otherrollButton->setVisible(false);

        if(ui->nc6_q18_otherComboBox->currentText() == deps->dal->translate("Item (Rank 6 or Lower)")){
            ui->nc6_q18_secondaryChoice_comboBox->setVisible(true);
            ui->nc6_q18_secondaryChoice_label->setVisible(true);
    ...
    ///
    else if (curAncestor == deps->dal->translate("Blood and Mortar")){
    ...
    else if (curAncestor == deps->dal->translate("Tainted Blood") ||
             curAncestor == deps->dal->translate("Elegant Craftsman") ||
             curAncestor == deps->dal->translate("Associated with a Natural Disaster") ||
             curAncestor == deps->dal->translate("Mark of the Elements")
             ){
        ui->nc6_q18_otherLabel->setVisible(true);
        ui->nc6_q18_otherComboBox->setVisible(true);
        ui->nc6_q18_otherrollButton->setVisible(false);
        if(ui->nc6_q18_otherComboBox->currentText() == deps->dal->translate("Void ring exchange")){
            ui->nc6_q18_secondaryChoice_comboBox->setVisible(false);
            ui->nc6_q18_secondaryChoice_label->setVisible(false);
            ui->nc6_q18_special1_comboBox->setVisible(true);
            ui->nc6_q18_special2_comboBox->setVisible(true);
        ...
        else if(ui->nc6_q18_otherComboBox->currentText() == deps->dal->translate("Air/Fire ring exchange")){
            ui->nc6_q18_secondaryChoice_comboBox->setVisible(false);
            ui->nc6_q18_secondaryChoice_label->setVisible(false);
            ui->nc6_q18_special1_comboBox->setVisible(true);
            ui->nc6_q18_special2_comboBox->setVisible(true);
        ...
        else if(ui->nc6_q18_otherComboBox->currentText() == deps->dal->translate("Ring Exchange")){
            ui->nc6_q18_secondaryChoice_comboBox->setVisible(false);
            ui->nc6_q18_secondaryChoice_label->setVisible(false);
            ui->nc6_q18_special1_comboBox->setVisible(true);
            ui->nc6_q18_special2_comboBox->setVisible(true);
...
void NewCharWizardPage6::on_nc6_q18_otherComboBox_currentIndexChanged(const QString &arg1)
{
    ...
    if(ui->heritagetable_comboBox->currentText()=="Core"){
        ...
        case 2:
            //heritage 1-2//////////////////////////
            if (effectresult == deps->dal->translate("weapon")){
                ui->nc6_q18_secondaryChoice_comboBox->addItems(deps->inventoryRepository->qsl_getitemsbytype("Weapon"));
            }
            else if (effectresult == deps->dal->translate("set of armor")){
                ui->nc6_q18_secondaryChoice_comboBox->addItems(deps->inventoryRepository->qsl_getitemsbytype("Armor"));

            }
            else if (effectresult == deps->dal->translate("another item")){
                ui->nc6_q18_secondaryChoice_comboBox->addItems(deps->inventoryRepository->qsl_getitemsbytype("Item"));

            }
            else if (effectresult == deps->dal->translate("horse or other animal")){
                ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Horse"));
                ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Animal"));

            }
            else if (effectresult == deps->dal->translate("boat or estate")){
                ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Estate"));
                ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Boat"));

            }
            ui->nc6_q18_special1_comboBox->addItems(deps->inventoryRepository->qsl_getqualities());
            ui->nc6_q18_special2_comboBox->addItems(deps->inventoryRepository->qsl_getqualities());
        ...
        case 9:
            // heritage 9
            if (effectresult == deps->dal->translate("Blessed Lineage")){
                //add blessed lineage -- no secondary pick.  Set in data?
            }
            break;
        case 10:
            ////////////////// Heritage 10
            if (effectresult == deps->dal->translate("Item (Rank 6 or Lower)")){
                //do item adds
                ui->nc6_q18_secondaryChoice_comboBox->addItems(deps->inventoryRepository->qsl_getitemsunderrarity(6));
            }
            else{ //rings
    ...
    //SL - SHadowlands heritage table
        ...
        case 6:
            ...
            if (effectresult == tr("No Change")){
                ...
                while (i.hasNext()) {
                    i.next();
                    if(i.key() == deps->dal->translate("Void"))
                        ui->nc6_q18_special1_comboBox->addItem (i.key());
                    if (i.value() > 1)
                        ui->nc6_q18_special2_comboBox->addItem (i.key());
                }
        ...
        case 1:
            break; //skill
        case 2:
            if (effectresult == deps->dal->translate("Any weapon")){
                ui->nc6_q18_secondaryChoice_comboBox->addItems(deps->inventoryRepository->qsl_getitemsbytype("Weapon"));
            }
            else if (effectresult == deps->dal->translate("Any game set")){
                ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Game Set"));

            }
            else if (effectresult == deps->dal->translate("Other item relevant to your ancestor's victory")){
                ui->nc6_q18_secondaryChoice_comboBox->addItems(deps->inventoryRepository->qsl_getitemsbytype("Item"));
            ...
            else if (effectresult == deps->dal->translate("The deed to a small piece of land on the border of Lion territory")){
                ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Estate"));
        ...
        case 6:
            if (effectresult == tr("No Change")){
                ...
                while (i.hasNext()) {
                    i.next();
                    if((i.key() == deps->dal->translate("Air") || i.key() == deps->dal->translate("Fire")) )
                        ui->nc6_q18_special1_comboBox->addItem (i.key());
                    if (i.value() > 1)
                        ui->nc6_q18_special2_comboBox->addItem (i.key());
                }
    ...
    //Fields of Victory
        ...
        switch (heritageRow) {
            ...
            case 7:
                if (effectresult == deps->dal->translate("weapon")){
                    ui->nc6_q18_secondaryChoice_comboBox->addItems(deps->inventoryRepository->qsl_getitemsbytype("Weapon"));
                } else if (effectresult == deps->dal->translate("Any weapon")) {
                    ui->nc6_q18_secondaryChoice_comboBox->addItems(deps->inventoryRepository->qsl_getitemsbytype("Weapon"));
                } else if (effectresult == deps->dal->translate("Any game set")) {
                    ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Game Set"));
                } else if (effectresult == deps->dal->translate("Other item relevant to your ancestor's victory")) {
                    ...
                    ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Horse"));
                    ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Animal"));
                } else if (effectresult == deps->dal->translate("The deed to a small piece of land on the border of Crane territory")) {
                    ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Estate"));
                }
            ...
            case 9:
                ...
                if (effectresult == deps->dal->translate("Item (Rank 6 or Lower)")){
                    ...
                    ui->nc6_q18_special1_comboBox->addItems(deps->inventoryRepository->qsl_getqualities());
                    ui->nc6_q18_special2_comboBox->addItems(deps->inventoryRepository->qsl_getqualities());
                } else if (effectresult == deps->dal->translate("Double your starting koku")) {
        ...
        case 4:
         ...
         case 5:
            ...
            else if (effectresult == deps->dal->translate("Valued piece of art")){
                ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Valued piece of art"));
            ...
            else if (effectresult == deps->dal->translate("Deed to a small piece of land on the border of Phoenix territory")){
                ui->nc6_q18_secondaryChoice_comboBox->addItem(deps->dal->translate("Deed to land in Phoenix territory"));
...
void NewCharWizardPage6::on_nc6_q18_otherrollButton_clicked()
{
   ...
   const QStringList rangestrings = deps->hertiagesRepository->qsl_getheritageranges(curAncestorBox->currentText());
   int roll = rand()%10+1;
   int index = 0;
...
void NewCharWizardPage6::on_heritagetable_comboBox_currentIndexChanged(const QString &arg1)
{
    ui->nc6_q18_ancestor1_comboBox->clear();
    ui->nc6_q18_ancestor2_comboBox->clear();
    ui->nc6_q18_ancestor1_comboBox->addItems(deps->hertiagesRepository->qsl_getancestors(arg1));
    ui->nc6_q18_ancestor2_comboBox->addItems(deps->hertiagesRepository->qsl_getancestors(arg1));
    ui->nc6_q18_ancestor1_comboBox->setCurrentIndex(-1);
    ui->nc6_q18_ancestor2_comboBox->setCurrentIndex(-1);
