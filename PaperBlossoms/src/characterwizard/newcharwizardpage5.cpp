...
NewCharWizardPage5::NewCharWizardPage5(DatabaseDependency *deps, QWidget *parent) :
    QWizardPage(parent),
...
{
    ui->nc5_q16_item_comboBox->addItems(deps->inventoryRepository->qsl_getitemsunderrarity(7));
    ui->nc5_q16_item_comboBox->setCurrentIndex(-1);

    ////////PoW
    ui->nc5_q14_item_comboBox->addItems(deps->inventoryRepository->qsl_getitemsunderrarity(5));
