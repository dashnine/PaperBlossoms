...
NewCharWizardPage4::NewCharWizardPage4(DatabaseDependency *deps, QWidget *parent) :
    QWizardPage(parent),
...
void NewCharWizardPage4::initializePage(){
    ...
    ui->nc4_q9_advdisadv_comboBox->addItems(deps->advantagesRepository->qsl_getadvdisadv("Distinctions"));
    ui->nc4_q10_advdisadv_comboBox->addItems(deps->advantagesRepository->qsl_getadvdisadv("Adversities"));
    ui->nc4_q11_advdisadv_comboBox->addItems(deps->advantagesRepository->qsl_getadvdisadv("Passions"));
    ui->nc4_q12_advdisadv_comboBox->addItems(deps->advantagesRepository->qsl_getadvdisadv("Anxieties"));
    ui->nc4_q13_adv_comboBox->addItems(deps->advantagesRepository->qsl_getadv());
    ui->nc4_q13_disaadv_comboBox->addItems(deps->advantagesRepository->qsl_getdisadv());
    ui->nc4_q13_skill_comboBox->addItems(deps->skillsRepository->qsl_getskills());
    regenSummary();
