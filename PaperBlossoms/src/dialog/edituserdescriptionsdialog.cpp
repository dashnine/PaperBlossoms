...
EditUserDescriptionsDialog::EditUserDescriptionsDialog(DatabaseDependency* deps, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::EditUserDescriptionsDialog)
{
    ...
    ui->optionComboBox->addItems(deps->dal->qsl_getdescribablenames());
