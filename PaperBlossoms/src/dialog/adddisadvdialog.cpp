...
AddDisAdvDialog::AddDisAdvDialog(DatabaseDependency* deps, Character* character, QString type,QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AddDisAdvDialog)
{
    ...
    ui->traitComboBox->addItems(deps->advantagesRepository->qsl_getadvdisadv(type));
}
